...
**SentinelPR v1.1.3** is an enterprise code and security review copilot for Java codebases, built on top of the **Shree AI OS** cognitive operating system platform (`io.github.darshanrathod04:shree-ai-os:1.0.6-developer-preview`).
...
jobs:
  audit:
    ...
    steps:
      ...
      - uses: darshanrathod04/sentinel-pr@v1.1.3
        with:
